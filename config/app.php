...
return [
    ...
    */
    ...
    'locale_default' => 'ru',
    'locales' => ['en' => 'English', 'fr' => 'French', 'es' => 'Spanish', 'it' => 'Italian', 'pt' => 'Portuguese', 'ru' => 'Russia', 'ua' => 'Ukraine', 'nl' => 'Dutch', 'de' => 'German' ],
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | User online timeout (in sec.)
    |--------------------------------------------------------------------------
    */

    'online_timeout' => env('ONLINE_TIMEOUT', 600),
