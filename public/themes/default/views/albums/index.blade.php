                            ...
                            <div class="widget-card">
                                <div class="widget-card-bg">	
                                    <a href="{{ url($timeline->username.'/album/show/'.$album->id) }}">
                                        ...
                                        <img src="{!! $album->previewImage()->first()->albumUrl($timeline->username) !!}" alt="{{ $album->name }}" title="{{ $album->name }}">
                                        @elseif ($album->photos()->first() != null)
                                        <img src="{{ $album->photos()->first()->albumUrl($timeline->username) }}" alt="{{ $album->name }}" title="{{ $album->name }}">
                                        @else
