                    ...
                    <div class="row" style="margin: 0 -5px;" >
                        ...
                        <div class="col-xs-12 games-search-box" style="padding: 0 5px;">
                            ...
                            <div class="games-search-box games-search-box_cat">
                                ...
                                <div class="games-box-head">
                                    <div class="games-box-head-title">
                                        <i class="icon-dodatky svoe-icon"></i>Игры
                                    </div>
                                ...
                                <div class="tab-content">
                                    <div role="tabpanel" class="tab-pane active">
                                        <div class="row" style="margin: 0 -5px;">
                                            ...
                                            @foreach($apps_games as $application)
                                                <div class="games-grid">
                                                    <a href="#">
                                                        <div class="game-image" style="background-image:url('https://static.esvoe.com/apps/promo_17@540x376.jpg')"></div>
                                                        <h5>Три в ряд</h5>
                                                        ...
                                                        <p class="game-members">7 участников</p>
                                                    </a>
                                                </div>
                                            @endforeach
                                            ...
                                            <div class="games-grid">                                            
                                                <a href="#">
                                                    <div class="game-image" style="background-image:url('https://static.esvoe.com/apps/promo_2@540x376.jpg')"></div>
                                                    <h5>Pharaon game</h5>
                                                    <span>Спортивные</span>
                                                    <div class="rating ratingblock">
                                                        <div class="ratingblock-content">
                                                            <span class="ratingblock-value">3.0</span>
                                                            <div class="stars stars-example-fontawesome-o">
                                                                <div class="br-wrapper br-theme-fontawesome-stars-o">
                                                                    <div class="br-widget">
                                                                        <span class="br-selected"></span>
                                                    ...
                                                    <p class="game-members">5 участников</p>
                                                </a>
                                            </div>   
                                            ...
                                            <div class="games-grid">                                           
                                                <a href="#">
                                                    ...
                                                    <div class="rating ratingblock">
                                                        <div class="ratingblock-content">
                                                            <span class="ratingblock-value">5</span>
                                                            <div class="stars stars-example-fontawesome-o">
                                                                <div class="br-wrapper br-theme-fontawesome-stars-o">
                                                                    <div class="br-widget">
                                                                        <span class="br-selected"></span>
                            ...
                            <div class="games-search-box games-search-box_cat">                           
                                <div class="games-box-head">
                                    <div class="games-box-head-title">
                                        <i class="icon-web svoe-icon"></i>Сайты
                                    </div>
                                </div>
                                <div class="tab-content">
                                    <div role="tabpanel" class="tab-pane active">
                            ...
                            <div class="games-search-box games-search-box_cat">                          
                                <div class="games-box-head">
                                    <div class="games-box-head-title">
                                        <i class="icon-media svoe-icon"></i>Медиа
                                    </div>
                                </div>
                                <div class="tab-content">
                                    <div role="tabpanel" class="tab-pane active">
                            ...
                            <div class="games-search-box games-search-box_cat">                          
                                <div class="games-box-head">
                                    <div class="games-box-head-title">
                                        <i class="icon-wallet svoe-icon"></i>Финансы
                                    </div>
                                </div>
                                <div class="tab-content">
                                    <div role="tabpanel" class="tab-pane active">
                            ...
                            <div class="games-search-box games-search-box_cat">                          
                                <div class="games-box-head">
                                    <div class="games-box-head-title">
                                        <i class="icon-kramnytsya svoe-icon"></i>Магазины
                                    </div>
                                </div>
                                <div class="tab-content">
                                    <div role="tabpanel" class="tab-pane active">
