	...
	<div class="row">
		...
		<form method="POST" action="{{ url('admin') }}">
			...
			<div class="privacy-question">
				...
				<h3>Продать токены</h3><hr>
				<div class="row">
					<div class="col-md-6">
						<h4>{{ trans('common.transfer_to_another') }}</h4>
					...
					<div class="col-md-6">
						<fieldset class="form-group">
							...
							{{ Form::label('sell_etoken', 'Продать токены') }}
							{{ Form::text('sell_etoken', Setting::get('custom_option1'), array('class' => 'form-control','placeholder' => 'Введите количество')) }}
						</fieldset>
					</div>
				</div>
				...
				<div class="pull-right">
					{{ Form::submit('Продать', ['class' => 'btn btn-success']) }}
				</div>
			</div>
		{{ Form::close() }}
	</div>
