        ...
        <div class="chat-box" v-bind:class="[chatBox.minimised ? 'chat-box-small' : '',  ]"  v-for="chatBox in chatBoxes">
            <div class="chat-box-header">
                <span class="side-left">
                    <span @click.prevent="toMessages(chatBox)"  class="chat-box-ico">
                        <img src="{!! Theme::asset()->url('images/_new/list.svg') !!}" aria-hidden="true" alt="" />
                    </span>
                ...
                <ul class="list-inline side-right">
                    <li class="minimize-chatbox chat-box-ico">
                        <a href="#">
                            <img class="import-hide" src="{!! Theme::asset()->url('images/_new/import.svg') !!}" @click.prevent="chatBox.minimised ? chatBox.minimised=false : chatBox.minimised=true" aria-hidden="true" alt="" />
                            <img class="import-show" src="{!! Theme::asset()->url('images/_new/import2.svg') !!}" @click.prevent="chatBox.minimised ? chatBox.minimised=false : chatBox.minimised=true" aria-hidden="true" alt="" />
                        </a>
                    </li>
                    <li class="close-chatbox chat-box-ico">
                        <a href="#" @click.prevent="chatBoxes.$remove(chatBox)" >
                            <img src="{!! Theme::asset()->url('images/_new/close.svg') !!}" aria-hidden="true" alt="" />
                        </a>
                    </li>
                </ul>
            </div>
