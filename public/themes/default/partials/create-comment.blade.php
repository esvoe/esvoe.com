...
<div class="block-what-comment">
    ...
    <div class="form-group">
        ...
        <form action="#" class="comment-form">
            <textarea cols="1" rows="1" data-emojiable="true" class="form-control post-comment" placeholder="Коментувати" data-post-id="{{ $post->id }}" name="post_comment"></textarea>
...
{{--        <div class="own-blocks-add" data-block-add-new="people" style="display: none;">
                                        <span>
                                            <img src="{!! Theme::asset()->url('images/_new/what-new-people.png') !!}"
                                                 alt="icon-what-new">
                                        </span>
        ...
        <div class="own-blocks-add" data-block-add-new="place" style="display: none;">
                                        <span>
                                            <img src="{!! Theme::asset()->url('images/_new/what-new-marker.png') !!}"
                                                 alt="icon-what-new">
                                        </span>
        ...
        <div class="own-blocks-add" data-block-add-new="youtube" style="display: none;">
                                        <span>
                                            <img src="{!! Theme::asset()->url('images/_new/what-new-youtube.png') !!}"
                                                 alt="icon-what-new">
                                        </span>
        ...
        <div class="own-blocks-add" data-block-add-new="photo" style="display: none;">
                                        <span>
                                            <img src="{!! Theme::asset()->url('images/_new/what-new-photo.png') !!}"
                                                 alt="icon-what-new">
                                        </span>
